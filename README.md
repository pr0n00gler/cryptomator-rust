...
* Unlocked content can be accessed via an embedded WebDav server
...
This will ask you for a password for your storage and if you provide the correct one the program starts a WebDav server with your unlocked vault:
```
...
Feb 22 17:11:24.167 INFO Starting WebDav server...
Feb 22 17:11:24.167 INFO WebDav server started on 127.0.0.1:4918
```
