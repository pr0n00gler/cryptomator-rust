use crate::crypto::{Cryptor, FileSystemError, MasterKey};
...
pub trait FileSystem: {
    fn read_dir(&self, path: &str) -> Result<Vec<String>, FileSystemError>;
    ...
    fn move_dir(&self, _src: &str, _dest: &str) -> Result<(), File>;
}
